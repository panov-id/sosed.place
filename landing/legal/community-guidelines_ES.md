...
**Un chat no se revisa.** Viaja cifrado de un dispositivo a otro y no podemos leerlo. **El tablero de juego es la excepción desde el 09/09/2026:** el tablero y las jugadas no van cifrados, los vemos y contrastamos las jugadas con las reglas del juego. Las palabras seguimos sin leerlas, con una excepción: la palabra que se propone en el ahorcado la ve nuestro servidor y la revisa como un mensaje publicado antes de que la vea el otro jugador — una palabra rechazada cuenta para la pausa de 15 minutos. Las reglas de abajo rigen allí igualmente; lo que cambia es cómo se hacen cumplir — mediante la denuncia de la otra persona, no mediante una revisión por nuestra parte.

## Sé un buen vecino

sosed es para buenos vecinos. Trata a la gente como querrías que te tratasen en tu propia calle. Con respeto y amabilidad.
...
Lo que de verdad puede pasar — y cada vez se te dice por qué: un mensaje no se publica; tras cinco rechazos en una hora, durante 15 minutos nada pasa a revisión; un mensaje desaparece para todos cuando lo denuncian suficientes personas, o se retira tras un aviso de contenido ilícito; la sospecha de un delito que amenace la vida o la seguridad de alguien se comunica a las autoridades. No reducimos la cuota de nadie ni cerramos el acceso de nadie a nuestra discreción. En una mesa, una jugada no hecha en 5 minutos se convierte en pase, y tres pases seguidos te pasan a espectador; puedes volver a jugar con una solicitud.

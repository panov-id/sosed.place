...
- **Counters about your identity.** Totals — how many likes you gave and received, how many matches and chats you have had. Numbers only: no text, no names, nobody you spoke to. Alongside them, **the moments of your publications and refusals within the last hour** (at most four and six, dropped once the hour has passed) and **the date of your first publication**, to the day — for the posting limit, the 15-minute pause and whether your report about a link in an offer counts. Kept while the identity lives.
...
- **A support message**: 1 year. When you start over, its link to your identity is cut at once and the message stays only as a record of how it was handled; a report of illegal content sent through support is moved to the notice register and deleted from support. **Detailed page views**: 14 days. **The admin audit log**: 1 year. **A nightly backup of our database**: 14 days, so anything you delete leaves our backups within a fortnight. **Server logs and client errors**: 30 days.
...
If a message is not published, you are told, and told why. These decisions are automatic: a message can be edited and sent again, a pause ends by itself after 15 minutes, and if you want a person to look, write to support.
...
We may update this Policy. There is no account to write to and no mailing list, so a new edition is signposted **at the door**: the next time you open the Service after a change, you are told that it changed and what changed. The "last updated" date at the top is the current edition.

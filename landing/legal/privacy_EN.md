...
- **To provide the Service** (performance of a contract / taking steps at your request): device identity, area, age, name, appearance, content.
...
- **Profile data** (identity, year of birth, name, and settings other than appearance) is kept while you use the Service in this browser.
...
You have the rights to **access, rectify, erase, restrict, object to, and port** your data, and to **withdraw consent**. Because the Service is ephemeral, much data is deleted automatically. To exercise your rights, contact **support@sosed.place**. You may also complain to your local data-protection authority (in Cyprus, the Office of the Commissioner for Personal Data Protection).
...
We may update this Policy. There is no account to write to and no mailing list, so a new edition is signposted **at the door**: the next time you open the Service after a change, you are told that it changed and what changed. Inside the Service, once you have an identity, you confirm a new edition with one checkbox before you publish or open a chat. The "last updated" date at the top is the current edition.

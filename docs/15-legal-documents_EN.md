...
- **Re-acceptance differs across the three documents — decided 2026-08-29.** The terms and the privacy policy: once they change, the identity cannot publish or open a chat until it accepts again, while the feed still reads (screen 11). The guidelines: the new revision is recorded silently and a mark appears under the link. The reason is that the guidelines restate mechanics that already apply, and stopping a conversation with them teaches people to press "accept" without reading. The price is accepted: three documents behave differently and that has to be explained — the explanation lives on this screen. (Moved out of open questions 2026-09-15: a decision, not a question.)

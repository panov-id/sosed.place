# Screen 20 — Stepping away

## Purpose

A temporary departure for someone who has been sitting here too long. Not "a pause for a minute" but a real disappearance for a chosen span: the full rules are in `00-mechanics_EN.md` §13; here is what a person sees.
...
- [retired] ~~"Until morning" across a change of time zone~~ — dropped on 2026-09-14 together with "until morning" itself: a fixed span has no time zone. The former decision: counted by the zone **at the moment of leaving**: the person chose morning where they were falling asleep. A zone shifting on a journey does not recompute the span, or a flight east would cut the break short in the middle of the night (settled 2026-08-27).

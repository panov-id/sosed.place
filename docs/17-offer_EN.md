...
- **An offer takes no ordinary quota slot** (`00-mechanics_EN.md` §3): offers have their own limits — a share of the feed and a rate limit per venue. The baker stays a neighbour with their own four phrases (edited 2026-09-14: this said "five", a relic of the quota retired on 2026-08-28 — the Russian half already said four).

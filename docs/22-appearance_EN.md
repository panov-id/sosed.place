...
- **This screen's edge states and their texts — screen 11** (`11-empty-and-edge-states_EN.md`): appearance with no connection; appearance when we did not answer — the choice is applied, and we save it as soon as we answer (added 2026-09-15 from the screen-state matrix).

...
- **A like is taken back by a second tap — decided 2026-09-15**, until an offer to talk has come of it; after that, declining is "not now" on the card (screen 6, `00-mechanics_EN.md` §11). A like on a private author's offer makes the offer at once, so it cannot be taken back.

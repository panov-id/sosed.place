...
- **The table's texts — the lens quorum's decision of 2026-09-18.** The line about the node: "there is no encryption at a table: the node sees the speech, the board and the stickers"; the moment of sitting down: "you are at the table from this moment"; an ordinary finish: "the game is over — the table stays" (the score stays in the header); the line-up confirmation card: the heading "Play again?", the subline "2 of 4 confirmed · 0:21", before expiry — "if you do not press within 30 s you stay a watcher"; behind the PIN lock there is no countdown — only "It is your move at the table."; on one's own move a collapsed board does not unfold by itself — the 44 px bar turns accent "your move · 4 min", the person unfolds it.
...
- **The only opponent left — the game ends at once (the owner's decision of 2026-09-18).** Fewer players than the set needs — the game closes with no result, the table stays, the one left sees "game over" and "play again" (screen 11, "Game over: the opponent left").
...
- **The first round is opened by a "start the game" button for whoever set the table — the owner's decision of 2026-09-18.** A table is set with an empty game; those who sit down apply, and "start the game" is the same proposal as "play again", only before the first game: the accepted applicants pass the 30-second "I'm here" and play. Until this decision nothing opened the first game (UX panel 2026-09-18).
- **The majority of the players (spectators do not decide — 2026-09-16; at least two votes: with one player there is no removal, with two both are needed — 2026-09-18) can ask someone to leave.** For whoever is removed the table leaves the screen and the socket closes; sitting down again is the same move, as long as nobody seated has blocked them (canon §6.1, 2026-09-08; refined 2026-09-17). Two out of three say "enough" and the person stands up. Nobody owns a table: the neighbour who started the game does not become its master.
...
- **Settled by drawing (2026-09-15).** How a table looks in the feed: a card with the board, a line with the game's name, two numbers (playing and watching) — settled by the lens quorum on 2026-09-18: before sitting down there is no board, in its place the line "sit down to see the board"; the name, the game, "N playing · M watching", the likes and the buttons — as on screen 23.

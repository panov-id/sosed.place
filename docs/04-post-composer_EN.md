...
- On send, the message goes through the same AI check described in the Moderation section (Google Perspective API for toxicity + LLM classification of explicitness) — it's published to the feed only after passing the check.

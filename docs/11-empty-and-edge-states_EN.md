...
- **A report went as a notice of illegal content (added 2026-09-14).** Support cannot take such a text, so it was sent the Article 16 way (screen 14). A line on the sending screen: "sent as a report of illegal content — the answer will come the same way". A report moved silently looks like one that went missing.

...
- **The tenth PIN mistake (added 2026-09-14).** The node's share is burned and this device's correspondence is erased for good (screen 12). The identity survives: the person sets a new PIN, the node issues a new share, and the device starts with an empty history. Until now this state existed neither here nor on screen 12 — only the warning before it.
...
| The tenth PIN mistake | Correspondence erased | Ten wrong PINs — the correspondence on this device is gone for good. Your identity is intact: set a new PIN. | Set a PIN |

...
**Decided 2026-08-10: it stays English, and that is a choice rather than a gap.**
The storefront speaks six languages and the community guidelines are translated
into more than ten, so the question was asked directly: should the policy and the
Terms follow. The answer is no. A translated legal text is a second edition, and
the moment one of them is edited the two say different things — quietly, and
exactly where being wrong is expensive. Anyone who needs the text in their own
language can translate it; we would rather it be unambiguous than reach further.
